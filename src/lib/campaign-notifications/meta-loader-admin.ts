/**
 * M7B.2 — Server-side Meta Monday bundle loader (admin).
 * Mirrors monday-meta-loader without browser supabase.
 */
...
export type MetaMondayBundleAdmin = {
...
export async function loadMetaMondayBundleAdmin(
  userId: string,
): Promise<MetaMondayBundleAdmin> {
